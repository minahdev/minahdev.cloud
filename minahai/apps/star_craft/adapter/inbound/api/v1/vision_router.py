...
from star_craft.app.dtos.yolo_dto import RecognizeYoloCommand
...
from star_craft.dependencies.vision_provider import get_recognize_use_case, get_vision_use_case

logger = logging.getLogger(__name__)

vision_router = APIRouter(prefix="/star_craft", tags=["star_craft"])
