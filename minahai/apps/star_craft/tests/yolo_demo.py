...
실행:
    cd minahai
    python apps/star_craft/tests/yolo_demo.py
"""
...
# 단독 실행 시 `star_craft.` 패키지를 찾을 수 있게 apps 디렉터리를 경로에 추가
APPS_DIR = Path(__file__).resolve().parents[2]  # .../minahai/apps
sys.path.insert(0, str(APPS_DIR))

from star_craft.adapter.outbound.resource_adapters.yolo.yolo_dataset_adapter import (  # noqa: E402
    LocalYoloDatasetAdapter,
)
from star_craft.app.dtos.yolo_dto import RecognizeYoloCommand, TrainYoloCommand  # noqa: E402
from star_craft.app.use_cases.yolo_interactor import (  # noqa: E402
